			...
			<div class="row align-items-center height-400">
				<div class="col-lg-12">
					<div class="page-banner-text text-center text-white">
						<h2>Hotel Interiors</h2> 
						<ul class="site-breadcrumb">
							<li><a href="index.php">Home</a> <span>></span></li>
							<li>Services <span>></span></li>
							<li>Commercial Gardening<span>></span></li>
...
<center>
	<div class="product-details-area mt-100 sm-mt-80">
		<h2>Hotel Interiors</h2><br>
		<div class="container">
				<div class="col-lg-3 col-md-3" style="padding-right: 20px">
					<ul class="nav nav-tabs products-nav-tabs">
						<li><a class="active" data-toggle="tab" href="#product-1"><img src="assets/images/img/HOTEL INTERIORS/6.jpg" alt="" /></a></li>&emsp;&emsp;&emsp;
						<li><a data-toggle="tab" href="#product-2"><img src="assets/images/img/HOTEL INTERIORS/5.jpg" alt="" /></a></li>&emsp;
					</ul>
				</div>
				<div class="col-lg-6 col-md-6">
					<div class="tab-content">
						<div id="product-1" class="tab-pane fade in show active">
							<img src="assets/images/img/HOTEL INTERIORS/Picture3.png" alt="" />
						</div>
						<div id="product-2" class="tab-pane fade">
							<img src="assets/images/img/HOTEL INTERIORS/Picture8.png" alt="" />
						</div>
					</div>
				</div>
		</div>
