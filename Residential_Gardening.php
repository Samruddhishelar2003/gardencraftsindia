...
hr.new3 {
  border-top: 3px dotted red;
	...
	<div class="page-banner-area bg-3">
		<div class="container">
			<div class="row align-items-center height-550">
				<div class="col-lg-12">
					<div class="page-banner-text text-center text-white pt-95">
						<h2>Residential Gardening</h2>
			...
			<div class="row">
				<div class="col-lg-4 col-md-4 col-sm-12">
					<div class="sidebar sm-mt-0">
						<div class="single-sidebar sidebar-menu">
							<ul class="list-none">
								<li>
									<a href="Kitchen_gardening.php">
										Kitchen Gardening
									</a>
								</li>
								<li>
									<a href="Balcony_Gardening.php">
									    Balcony Gardening
									</a>
								</li>
								<li>
									<a href="Vertical_Gardening.php">
										Vertical Gardening
									</a>
								</li>
								<li>
									<a href="Terrace_Gardening.php">
										Terrace Gardening 
									</a>
								</li>
							</ul>
				...
				<div class="col-lg-8 col-md-8 col-sm-12">
					<img src="assets/images/img/home-design.jpg" alt="service" />
					<div class="service-text-block fix">
					...
					<div class="row mt-40">
						<div class="col-sm-12">
							<div id="accordion" class="faq-section">
								<h3 class="mb-20">FAQ's On Watering Garden</h3>
								<div class="card single-faq style-2">
...
-->
				...
				<div class="row mt-40">
						<div class="col-lg-3 img-100p">
							<img src="assets/images/img/Kitchen Gardening.jpg" alt="service" />
							<div class="single-sidebar sidebar-menu">
								<ul class="list-none">
								<li>
									<a href="Kitchen_gardening.php" style="text-align: center">
										Kitchen Gardening
									</a>
								</li>
							</ul>
						...
						<div class="col-lg-3 sm-mt-30 img-100p">
							<img src="assets/images/img/Balcony Gardening.jpg" alt="service" />
							<div class="single-sidebar sidebar-menu">
								<ul class="list-none">
								<li>
									<a href="Balcony_Gardening.php" style="text-align: center">
										Balcony Gardening
									</a>
								</li>
							</ul>
					...
					<div class="col-lg-3 sm-mt-30 img-100p">
							<img src="assets/images/img/Vertical Gardening/Vertical Gardening.jpg" alt="service" />
							<div class="single-sidebar sidebar-menu">
								<ul class="list-none">
								<li>
									<a href="Vertical_Gardening.php" style="text-align: center">
										Vertical Gardening
									</a>
								</li>
							</ul>
					...
					<div class="col-lg-3 sm-mt-30 img-100p">
							<img src="assets/images/img/terrace-garden1_mini.webp" alt="service" />
							<div class="single-sidebar sidebar-menu">
								<ul class="list-none">
								<li>
									<a href="Terrace_Gardening.php" style="text-align: center">
										Terrace Gardening
									</a>
								</li>
							</ul>
